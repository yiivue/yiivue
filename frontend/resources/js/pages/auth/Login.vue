    ...
    <div class="max-w-md w-full space-y-8 animate-fade-in">
      <div class="text-center">
        ...
        <h2 class="text-3xl font-black tracking-tight text-gray-900  uppercase">
          Welcome <span class="text-[#7cb342]">Back</span>.
        </h2>
      ...
      <div class="bg-white  p-8 rounded-3xl border border-gray-100  shadow-2xl shadow-gray-200/50 ">
        <form @submit.prevent="handleLogin" class="space-y-6">
          <div class="space-y-2">
            ...
            <Input id="email" type="email" v-model="email" placeholder="name@example.com" required
              class="h-12 rounded-xl border-gray-200  bg-gray-50/50  focus:ring-[#185b8f] focus:border-[#185b8f] transition-all" />
          </div>

          <div class="space-y-2">
            <div class="flex items-center justify-between">
              <Label for="password" class="text-xs font-bold uppercase tracking-wider text-gray-500">Password</Label>
              <a href="#" class="text-xs font-bold text-[#185b8f] hover:underline">Forgot password?</a>
            </div>
        ...
        <div class="mt-8 pt-6 border-t border-gray-100  text-center">
          <p class="text-sm text-gray-500 ">
            ...
            <router-link to="/register" class="font-bold text-[#185b8f] hover:underline">Create Account</router-link>
          </p>
        </div>
      </div>
    </div>
