<template>
  <div
    ...
    <!-- Background glow -->
    <div
      class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl h-96 bg-[#FF2D20]/5 blur-[120px] -z-10 rounded-full">
    </div>
    ...
    <div class="max-w-md w-full space-y-8 animate-fade-in">
      <div class="text-center">
        <router-link to="/" class="inline-flex items-center gap-2 mb-6 group">
          <div
            class="size-12 rounded-2xl bg-[#FF2D20] flex items-center justify-center text-white shadow-lg shadow-[#FF2D20]/20 group-hover:scale-105 transition-transform">
        ...
        <h2 class="text-3xl font-black tracking-tight text-gray-900  uppercase">
          Create <span class="text-[#FF2D20]">Account</span>.
        </h2>
      ...
      <div
        ...
        <form @submit.prevent="handleRegister" class="space-y-5">
          <div class="space-y-2">
            ...
            <Input id="username" type="text" v-model="username" placeholder="johndoe" required
              class="h-11 rounded-xl border-gray-200  bg-gray-50/50  focus:ring-[#FF2D20] focus:border-[#FF2D20] transition-all" />
          </div>
          ...
          <Button type="submit"
            class="w-full h-12 rounded-xl bg-[#FF2D20] hover:bg-[#e0261b] text-white font-bold uppercase tracking-widest text-xs shadow-lg shadow-[#FF2D20]/20 transition-all hover:-translate-y-0.5"
        ...
        <div class="mt-8 pt-6 border-t border-gray-100  text-center">
          <p class="text-sm text-gray-500 ">
            ...
            <router-link to="/login" class="font-bold text-[#FF2D20] hover:underline">Sign In</router-link>
          </p>
        </div>
      </div>
    </div>
